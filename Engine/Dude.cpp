...
void Dude::ClampToScreen() // neither const nor by ref because this IS a mutator function
{
...
void Dude::Draw( Graphics& gfx ) const  // const member function (non-mutator) because it does not change Poo or its members
{
